...
import laptop from '/Users/rafaysalahuddin/Portfolio/rafay/src/Components/laptop.png'
import hat from '/Users/rafaysalahuddin/Portfolio/rafay/src/Components/hat.png'
...
export class LandingPage extends React.Component{
    render(){
       ...
       <button href='/contactInfo'className="btns"><a href='./contactInfo' className = 'connect' >CONNECT</a></button>
       <br/><br/><br/>
